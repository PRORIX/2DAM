...
public class BatallaPokemon {
    ...
    /**
     * Metodo que gestiona los ataques y el cambio de puntos de vida.
     * @param atacante nombre del pokemon atacante
     * @param esPikachu indica si el ataque pertenece a Pikachu
     */
    ...
    private final Runnable pikachu = () -> {
        while (!juegoTerminado.get()) {
            ...
            try {
                ...
                boolean puedeAtacar = !juegoTerminado.get();
                if (!puedeAtacar) break;
                atacar("Pikachu", true);
                turno = "Charmander";
                turnoCambio.signal();
