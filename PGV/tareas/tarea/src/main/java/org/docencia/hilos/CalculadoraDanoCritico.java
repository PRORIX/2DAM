...
public class CalculadoraDanoCritico {
    ...
    static class TareaCalcularDano implements Callable<Integer> {
        ...
        public Integer call() throws Exception {
            ...
            System.out.println("[" + hilo + "] Calculando daño critico para " + ataque.atacante);
            ...
            System.out.println("[" + hilo + "] " + ataque.atacante + (esCritico ? " ¡CRITICO!" : " golpe normal") + " -> daño: " + danoFinal);
    ...
    public static void main(String[] args) {
        System.out.println("=== Iniciando Calculadora de Daño Critico ===");
        ...
        Ataque[] ataques = {
                ...
                new Ataque("Arquera Elfa", 110, 0.35, 2.2),
